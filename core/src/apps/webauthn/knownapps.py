...
def by_rp_id_hash(rp_id_hash: bytes) -> Optional[FIDOApp]:
    if False:
        ...
        # WebAuthn key for www.binance.com
        return FIDOApp(
        ...
        # U2F key for vault.bitwarden.com
        return FIDOApp(
        ...
        # WebAuthn key for www.dropbox.com
        return FIDOApp(
            label="www.dropbox.com",
            icon="apps/webauthn/res/icon_dropbox.toif",
            use_sign_count=False,
        ...
        # U2F key for keepersecurity.com
        return FIDOApp(
        ...
        # WebAuthn key for login.microsoft.com
        return FIDOApp(
